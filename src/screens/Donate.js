...
const Donate = () => (
    <div className='container'>
        <h5>Donation is coming soon...</h5>
        <section>
            <p>If you're willing to donate, please contact us! <a target='_blank' rel='noopener noreferrer' href='mailto:contact@monotones.app'>contact@monotones.app</a></p>
            {/* <h5>PayPal</h5>
